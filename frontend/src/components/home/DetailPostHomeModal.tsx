...
import style from "./css/DetailPostHomeModal.module.css";
...
const DetailPostHomeModal: React.FC<Props> = ({ post, onClose }) => {
                                ...
                                <Typography variant="body2">
                                    ...
                                    {currentPost && currentPost.likedUserInfo.length > 0
                                        ? `${currentPost.isLiked
                                            ...
                                            ? ` and ${currentPost.likedUserInfo.length - 1
                                            } other${currentPost.likedUserInfo.length - 1 > 1
                                                ? "s"
                                                : ""
                                            }`
                                            : ""
...
export default DetailPostHomeModal;
